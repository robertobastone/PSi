...
class PSiParabolicSiever:
    ...
    def __init__(self):
        print colored("Initializing...PSiParabolicSiever version " + str(version), 'blue')
        
    def siever(self):
        frame = 7                            # size of plot
        while True:
            try:
                integer = int(input(">Choose how many integers to display: "))
                ...
                print colored("Error! You have not chosen an integer", 'red')            
